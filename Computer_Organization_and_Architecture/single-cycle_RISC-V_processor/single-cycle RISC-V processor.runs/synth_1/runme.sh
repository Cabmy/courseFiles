...
HD_PWD='C:/Users/24903/Desktop/single-cycle_RISC-V_processor/single-cycle RISC-V processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_processor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_processor_top.tcl
