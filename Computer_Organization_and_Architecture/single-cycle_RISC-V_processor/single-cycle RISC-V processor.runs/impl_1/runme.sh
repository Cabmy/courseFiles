...
HD_PWD='C:/Users/24903/Desktop/single-cycle_RISC-V_processor/single-cycle RISC-V processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_processor_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv_processor_top.tcl -notrace
